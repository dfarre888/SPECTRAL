  ...
  return (
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link
          href="/pcm/scenario"
          className="store-panel rounded-xl border border-[var(--store-line)] p-5 hover:border-[rgba(41,151,255,0.5)] transition-colors"
        >
          <Crosshair className="w-5 h-5 text-[var(--wb-blue)] mb-3" />
      ...
      <StorePanel className="mt-6 p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <Link
          ...
          className="store-btn-secondary px-4 py-2 text-xs font-semibold shrink-0 text-center border border-[var(--store-line)] rounded-xl hover:border-[rgba(41,151,255,0.5)]"
        >
