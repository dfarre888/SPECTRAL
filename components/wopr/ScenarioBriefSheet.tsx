    ...
    <div className="fixed inset-0 z-[9998] overflow-auto bg-black/70 brief-root">
      ...
      <style jsx global>{`
        ...
        .brief-btn {
          ...
          padding: 7px 14px; border-radius: 8px; border: 1px solid #d4d4d8; background: #fafafa; color: #111;
        }
        .brief-btn-primary { background: #1F86EE; border-color: #1F86EE; color: #fff; }
        ...
        .brief-callout { background: #fffbeb; border: 1px solid #fcd34d; padding: 12px 14px; border-radius: 8px; font-size: 13px; }
        .brief-callout p { margin: 0; }
        .brief-table { width: 100%; border-collapse: collapse; font-size: 12px; }
        .brief-table th {
          text-align: left; font: 700 11px ui-monospace, monospace; text-transform: uppercase;
